    ...
    return (
        <Container className='w-25 mx-auto mt-5 border rounded p-4' style={{ boxShadow: ' -10px 10px #FFE0B3' }}>
            ...
            <Form onSubmit={handleRegister}>
                ...
                <div className="mt-5">
                    <button onClick={handleLoginWithGoogle} className="w-100 d-flex align-items-center justify-content-center "> <img className='me-2' style={{ width: '20px' }} src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/53/Google_%22G%22_Logo.svg/2008px-Google_%22G%22_Logo.svg.png" alt="" /> Continue with Google</button>
                </div>
            </Form>
        </Container>
    );
